...
class mpNode(Node):
    ...
    def __init__(self):
        ...
        self.pub_text = self.create_publisher(String, 'topic', 10)
        self.get_logger().info("This is %s!" % 'mp_node')
        self.i = 0
        self.run_pub()
...
if __name__ == '__main__':
    ...
    # ros2 pkg create mp_test2 --build-type ament_python --dependencies rclpy
